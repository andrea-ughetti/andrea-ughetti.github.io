...
// "system". Local override of al_folio_core's assets/js/theme.js (see
// docs/ARCHITECTURE.md "local overrides"): default (first visit, nothing
// in localStorage yet) is "dark" instead of upstream's "system", so the
// site opens in dark mode rather than following the visitor's OS
// preference. The toggle still cycles system/light/dark as normal, and
// once a visitor picks anything, that choice is what's remembered.
